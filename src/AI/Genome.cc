...
Genome::Genome(const Genotype<Neuron> &neurons, const Genotype<Connection> &connections) {
    this->neurons_ = Genotype<Neuron>(neurons);
    this->connections_ = Genotype<Connection>(connections);
}
